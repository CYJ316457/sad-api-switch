...
export const apiAdapter: ApiAdapter = {
  ...
  pool: {
    ...
    create: (params) =>
      useTauri()
        ? tauriCmd<ApiEntry>('create_entry', { params: { channel_id: params.channelId, model: params.model, upstream_model: params.upstreamModel, display_name: params.displayName, group_name: params.groupName } })
    ...
    updateUpstreamModel: (id, upstreamModel) =>
      useTauri()
        ...
        : webRequest<void>('PUT', `/pool/${id}/upstream-model`, { upstream_model: upstreamModel }),
  },
